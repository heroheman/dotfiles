...
set wildignore+=*/tmp/*,*.so,*.swp,*.zip,*.bak,*.pyc,*.class,*.un~    " MacOSX/Linux
...
noremap <leader><Tab> :call quickmenu#bottom(0)<cr>
...
call quickmenu#append("Magit", 'Magit', "Magit")
call quickmenu#append("Gitv", 'Gitv', "Git Browse")
call quickmenu#append("GitGutter", 'GitGutterToggle', "Git Gutter Toggle")
...
call quickmenu#append("Gundo Toggle", 'UndotreeToggle', "Toggle Gundo")
...
let g:rg_command = '
  ...
  \ -g "!{.loki,.git,node_modules,vendor,dist,build,public,package-lock.json}/*" '
...
call airline#parts#define('zoom', {'function': 'zoom#statusline'})
let g:airline_section_b = airline#section#create_left(['zoom'])
"}}}
" Plugin: LIVEDOWN"{{{
...
nnoremap <leader>fps :Prettier<CR>:w<CR>


" Mappings using CoCList:
" Show all diagnostics.
nnoremap <silent> coca  :<C-u>CocList diagnostics<cr>
" Manage extensions.
nnoremap <silent> coce  :<C-u>CocList extensions<cr>
" Show commands.
nnoremap <silent> cocc  :<C-u>CocList commands<cr>
" Find symbol of current document.
nnoremap <silent> coco  :<C-u>CocList outline<cr>
" Search workspace symbols.
nnoremap <silent> cocs  :<C-u>CocList -I symbols<cr>
